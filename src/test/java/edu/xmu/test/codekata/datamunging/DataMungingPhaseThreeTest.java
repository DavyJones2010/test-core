...
public class DataMungingPhaseThreeTest {
	DataMungingPhaseThree instance;

	// FastDateFormat formatter = FastDateFormat.getInstance("dd-MMM-yy");

	@Before
	public void setUp() throws ParseException {
		instance = new DataMungingPhaseThree();
	...
	public void populateColumnTest() {
		System.out.println(instance.populateSumColumn(Pair.of("numEmps", "raisedAmt")));
		System.out.println(instance.populateDiffColumn(Pair.of("numEmps", "raisedAmt")));
		System.out.println(instance.populateMultipleColumn(Pair.of("numEmps", "raisedAmt")));
		System.out.println(instance.populateDividendColumn(Pair.of("numEmps", "raisedAmt")));
	}

	@Test
	public void getAggregatedPopulateColumnTest() {
		System.out.println(instance.setLines(instance.populateSumColumn(Pair.of("numEmps", "raisedAmt"))).getMaxEntries("Sum Of " + Pair.of("numEmps", "raisedAmt")));
		System.out.println(instance.setLines(instance.populateDiffColumn(Pair.of("numEmps", "raisedAmt"))).getMinEntries("Diff Of " + Pair.of("numEmps", "raisedAmt")));
		System.out.println(instance.setLines(instance.populateMultipleColumn(Pair.of("numEmps", "raisedAmt"))).getMaxEntries("Multiple Of " + Pair.of("numEmps", "raisedAmt")));
		System.out.println(instance.setLines(instance.populateDividendColumn(Pair.of("numEmps", "raisedAmt"))).getMinEntries("Dividend Of " + Pair.of("numEmps", "raisedAmt")));
	}
}
